...
class ContainerSampling(Sampling):
    ...
    def __init__(self, container_width_px: float, container_height_px: float, blueprint: BlueprintContainer) -> None:
        super().__init__()
    ...
    def _do(self, problem, n_samples, *args, random_state=None, **kwargs):
        ...
        for _ in range(n_samples):
            container = self.blueprint.get_new_container(self.container_width_px, self.container_height_px)
